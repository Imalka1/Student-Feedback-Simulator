...
<div style="margin-top: 75px;margin-left: 30px;margin-right: 30px">
    ...
    <div class="row">
        <div class="col-12" style="margin-top: 20px;font-size: 15px" id="subjectLecturerName">
            <b>Subject :- </b>No lecturer selected
        </div>
    </div>
        ...
        <div class="col-12" style="padding: 0px">
            <table border="1px" style="width: 100%">
                <tr style="font-size: 18px">
                    <th width="5%"></th>
                    <th width="10%" style="text-align: center">Subject Code</th>
                    <th width="55%" style="text-align: center">Subject Title</th>
                    <th width="15%" style="text-align: center">Semester</th>
                    <th width="8%" style="text-align: center">Current</th>
                    <th width="7%" style="text-align: center">Remove</th>
                </tr>
                <tbody id="subjectLecturerBody">
                </tbody>
            </table>
        </div>
    </div>

...
@WebServlet(urlPatterns = "/add_subject_lecturer")
public class AddSubjectLecturerController extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (new SubjectLecturerController().addSubjectLecturer(subjectLecturer)) {//---Call the db server (SubjectController(db_controller)) to add subject

...
@WebServlet(urlPatterns = "/load_lecturers_via_subject")//---URL extension which mapped to this servlet object
public class LoadLecturersViaSubjectController extends HttpServlet {
    @Override
